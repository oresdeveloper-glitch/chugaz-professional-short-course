...
export default function CourseDetailLoading() {
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-[#0B1F4D]">
      <div className="relative flex flex-col items-center gap-6">
        ...
        <p className="text-white/60 font-body text-sm tracking-widest uppercase">Loading Course Details</p>
      </div>
    </div>
  )
}